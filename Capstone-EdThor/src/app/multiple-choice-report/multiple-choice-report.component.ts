...
@Component({
  selector: 'app-multiple-choice-report',
  templateUrl: './multiple-choice-report.component.html',
  styleUrls: ['./multiple-choice-report.component.css', '../summary/summary.component.css', '../problem-set/problem-set.component.css', "../../assets/css/bootstrap.min.css"],
  animations: [
    trigger('state', [
...
export class MultipleChoiceReportComponent implements OnInit {
